...
export class TextTransformerSettingsMenu extends PluginSettingTab {
	...
	private _renderApiModelSection(containerEl: HTMLElement): void {
		...
		const contentStructure: Array<{ type: "text" | "strong" | "br"; text?: string }> = [
			...
			{ type: "text", text: " - Intelligence = 4, Speed = 60 tps, Price = $0.018" },
			{ type: "br" },
			...
			{ type: "text", text: " - Intelligence = 2, Speed = 40-55 tps, Price = $0.0004" },
			{ type: "br" },
			{ type: "strong", text: "ⓡ Llama 3.3 70B Instruct" },
			{ type: "text", text: " - Intelligence = 3, Speed = 30-76 tps, Price = $0.0004" },
			{ type: "br" },
			...
			{
				type: "text",
				text: " - their largest model, demonstrates enhanced emotional intelligence, creativity, nuanced character portrayal. Context: 131k, Speed: 28 tps, Price = $0.0018 NSFW: partial",
			},
			{ type: "br" },
			...
			{ type: "text", text: " - Speed = 84 tps, Context 8k, Price: $0.0125" },
			{ type: "br" },
			{ type: "strong", text: "ⓡ Mistral Large 2411" },
			{ type: "text", text: " - Speed = 50 tps, Context 8k, Price: $0.008" },
		];
