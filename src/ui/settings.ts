...
export class TextTransformerSettingsMenu extends PluginSettingTab {
	...
	private _renderApiModelSection(containerEl: HTMLElement): void {
		...
		const contentStructure: Array<{ type: "text" | "strong" | "br"; text?: string }> = [
			...
			{ type: "text", text: " - Intelligence = 4, Speed = 60 tps, Price = $?" },
			{ type: "br" },
			...
			{ type: "text", text: " - Intelligence = 3, Speed = 30-62 tps, Price = $?" },
			{ type: "br" },
			{ type: "strong", text: "ⓡ Qwen 3 32B" },
			{ type: "text", text: " - Intelligence = 2, Speed = 40-55 tps, Price = $?" },
			{ type: "br" },
			{ type: "strong", text: "ⓡ Llama 3.3 70B Instruct" },
			{ type: "text", text: " - Intelligence = 3, Speed = 30-76 tps, Price = $?" },
			{ type: "br" },
			{ type: "strong", text: "ⓡ Llama 3.1 405B Instruct" },
			{ type: "text", text: " - Intelligence = 4, Speed = 30-57 tps, Price = $?" },
			{ type: "br" },
			{ type: "strong", text: "ⓡ Nvidia/Llama 3.1 Nemotron Ultra 253B v1" },
			{ type: "text", text: " - Intelligence = 4, Speed = 42 tps, Price = $?" },
			{ type: "br" },
			...
			{ type: "text", text: " - Speed = 84 tps, Context 8k, Price: $?" },
			{ type: "strong", text: "ⓡ Mistral Large 2411" },
			{ type: "text", text: " - Speed = 50 tps, Context 8k, Price: $?" },
		];
