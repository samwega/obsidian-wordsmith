...
export async function openAiRequest(
	...
	if (oldText === "" && additionalContextForAI?.includes("<<<GENERATION_TARGET_CURSOR_POSITION>>>")) {
        ...
        systemMessageContent += 
            ...
            "User's transformation instruction: " + prompt.text + ". Apply this instruction ONLY to the user-provided text that follows.";
    }
